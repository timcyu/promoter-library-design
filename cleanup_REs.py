# This script removes any promoter sequences that contain the restriction sites we will use for cloning

import sys
import argparse
import itertools

# Read in FASTA into dictionary format where keys are headers and sequences are values
...
# Ignoring primers, removes the promoter sequence if there contains any restriction sites
...
# Generates either a tab or fasta format file of all the good promoters
